...
{
    static void write_uint32(final java.io.FileOutputStream f, final int v)
    {
    ...
    static void write_uint16(final java.io.FileOutputStream f, final int v)
    {
        final byte[] outputBytes = new byte[2];
    ...
    public static void wavwriter_writeheaders(final java.io.FileOutputStream f, final int datasize, final int numchannels, final int samplerate, final int bytespersample, final int bitspersample)
    {
        final byte[] buffAsBytes = new byte[4];
