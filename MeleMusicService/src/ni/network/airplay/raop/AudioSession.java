...
import ni.network.airplay.alacdecoder.AlacFile;
...
public class AudioSession {
    ...
    private final int timingPort;
    private final int frameSize;
    private final int sampleSize;
    private final int _7a;
    private final int rice_historymult;
    private final int rice_initialhistory;
    private final int rice_kmodifier;
    private final int _7f;
    private final int _80;
    private final int _82;
    private final int _86;
    private final int _8a_rate;
    private BiquadFilter bFilter;

    public AudioSession(final byte[] aesiv, final byte[] aeskey, final int[] fmtp, final int controlPort, final int timingPort) {
        // KEYS
        this.aesiv = aesiv;
        this.aeskey = aeskey;
    ...
    public void updateFilter(final int size) {
        bFilter.update(size);
    }
